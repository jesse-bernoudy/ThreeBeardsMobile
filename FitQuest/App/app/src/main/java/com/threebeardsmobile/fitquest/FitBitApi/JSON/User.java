...
public class User {
    ...
    @SerializedName("customHeartRateZone")
    @Expose
    private CustomHeartRateZone customHeartRateZone;
    ...
    /**
     * @return The customHeartRateZone
     */
    public CustomHeartRateZone getCustomHeartRateZone() {
        return customHeartRateZone;
    }

    /**
     * @param customHeartRateZone The customHeartRateZone
     */
    public void setCustomHeartRateZone(CustomHeartRateZone customHeartRateZone) {
        this.customHeartRateZone = customHeartRateZone;
    }
